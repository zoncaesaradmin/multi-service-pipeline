...
│
└── ../../../client/golang/src/platformkit/  # Shared module
    ├── go.mod               # Module: platformkit
    ├── go.sum               # Go module checksums
...
go work use ./service ./testrunner ../../../client/golang/src/platformkit  # Add modules to workspace
```
...
```bash
cd ../../../client/golang/src/platformkit
make test
```
...
cd ../../../client/golang/src/platformkit && make clean
```
...
cd ../../../client/golang/src/platformkit && make deep-clean
```
...
### Project Architecture
- **Multi-module workspace**: Uses Go workspace with service, testrunner, and platformkit modules
...
3. Update message types in `../../../client/golang/src/platformkit/types/types.go`
4. Add unit tests for new processing logic
5. Add integration tests in `testrunner/internal/tests/`

#### Message Bus Features
1. Add new interfaces in `../../../client/golang/src/platformkit/messagebus/mbinterfaces.go`
2. Implement in `../../../client/golang/src/platformkit/messagebus/localbus.go` for local development
3. Implement in `../../../client/golang/src/platformkit/messagebus/kafkabus.go` for production
...
go work use ../../../client/golang/src/platformkit  # Add shared module
...
cd ../../../client/golang/src/platformkit && go mod tidy  # Manage shared dependencies
```

### Testing Strategy
1. **Unit Tests**: Test individual functions in each module (service, testrunner, platformkit)
...
- **Multi-module management**: Work with service, testrunner, and platformkit modules in a single workspace
- **Cross-module development**: Make changes across service, testrunner, and platformkit simultaneously
...
go work use ../../../client/golang/src/platformkit  # Add shared module to workspace
go work sync                 # Sync workspace modules
