Feature: Data integrity
  ...
  Scenario: Check for data loss and field integrity
    Given send input config "sampleconfig.json" over kafka topic "cisco_nir-alertRules"
    And send input data "sampledata2.json" over kafka topic "cisco_nir-anomalies"
