...
- **Bus Location**: `/tmp/kritikos-messagebus/`
...
| SERVER_PORT | 4577 | Health check server port |
...
Local development uses file-based message bus at `/tmp/kritikos-messagebus/`.
...
```bash
# Check message files
ls -la /tmp/kritikos-messagebus/test_input/
ls -la /tmp/kritikos-messagebus/test_output/

# View message content
cat /tmp/kritikos-messagebus/test_input/0000000000.json | jq .
cat /tmp/kritikos-messagebus/test_output/0000000000.json | jq .
```
