...
```
infra-services/kritikos/src/testrunner/
...
- **Message Bus Integration**: 
  - Local: File-based at `/tmp/kritikos-messagebus/`
...
# View test messages
cat /tmp/kritikos-messagebus/test_input/*.json

# Monitor responses
tail -f /tmp/kritikos-messagebus/test_output/*.json
```
